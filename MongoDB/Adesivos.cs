...
namespace FormularioGrafica.MongoDB {
    ...
    public partial class Adesivos : UserControl {
        ...
        private void carregarCampos() {
            ...
            vetorBson.Add(dBConnect.BuscaDocumento("Ima1_inicial.png"));
            vetorBson.Add(dBConnect.BuscaDocumento("Adesivos2_inicial.png"));
            vetorBson.Add(dBConnect.BuscaDocumento("Tag3_inicial.png"));
            vetorBson.Add(dBConnect.BuscaDocumento("Adesivo4_inicial.png"));
        }
